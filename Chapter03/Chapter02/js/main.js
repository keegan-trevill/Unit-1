...
// This function writes the script to the browser without manipulating anyy of the data from the file
...
function debugAjax() {
    //retrives the file from the data folder
    fetch("data/MegaCities.geojson")
    //returns data in response variable    
    .then(function(response) {
            return response.json();
        })
        //calls the Callback function with the response variable
        .then(function(response){ 
